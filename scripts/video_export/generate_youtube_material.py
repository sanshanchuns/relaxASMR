...
def render_markdown(
    ...
    lines = [
        ...
        f"- 布局参考 `thumbnail_ref.png`：英文标题水平居中、距顶 {TITLE_TOP_Y}px · 4K 角标左下 · 无时长标签",
...
def main() -> None:
    ...
    preset = load_preset(parsed.get("project", stem))
    ...
    thumb_title = args.title_en or preset.get("thumb_title_en") or title_en
