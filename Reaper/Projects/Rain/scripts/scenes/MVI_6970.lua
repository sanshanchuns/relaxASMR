-- 场景配方 · 见 subprojects/MVI_6970/video_analysis.md §三
-- 由 create_rain_subproject.py 自动生成

return {
  scene_id = "MVI_6970",
  project_name = "Rain · MVI_6970",
  series = "rain_sleep",
  duration_hours = 3.0,

  video = {
    track = 7,
    name = "Video · MVI_6970 loop",
    path = "assets/loop_video/rain_video/MVI_6970/MVI_6970_loop_0.99_dur_7_fade_0.5.mp4",
    render_only = true,
  },
  ...
  loop_layers = {
    {
      ...
      vol = 1.0,
      paths = {
        "assets/sound_effect/rain_sound/1_rain/intensity/drizzle/173647_Rain,_Vegetation,_Rain,_Daytime,_Mid_To_Hard_Rainfall,_Havelock_Island,_Second_02.mp3",
      },
    },
    {
      track = 3,
