-- 场景配方 · 见 subprojects/MVI_6952/video_analysis.md §三
-- 由 create_rain_subproject.py 自动生成

return {
  scene_id = "MVI_6952",
  project_name = "Rain · MVI_6952",
  series = "rain_sleep",
  duration_hours = 3,

  video = {
    track = 7,
    name = "Video · MVI_6952 loop",
    path = "assets/loop_video/rain_video/MVI_6952_loop_0.94_dur_6_fade_0.5.mp4",
    render_only = true,
  },
